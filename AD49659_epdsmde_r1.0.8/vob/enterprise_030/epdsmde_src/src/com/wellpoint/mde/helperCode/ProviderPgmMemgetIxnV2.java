...
public class ProviderPgmMemgetIxnV2 {
	...
	ProcessProviderPgmMemget objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessProviderPgmMemget();
  ...
  public static void main(String[] args) {
	  ProviderPgmMemgetIxnV2 jtx = new ProviderPgmMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(57074105);
