...
public class ExecuteGrp {
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessGrpMemget();
  ...
  public static void main(String[] args) {
    	ExecuteGrp jtx = new ExecuteGrp();
		try	{
			
			jtx.execute_memGet(50639898);
