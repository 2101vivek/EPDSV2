...
public class HmoMemgetIxnV2 {
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessHmoMemget();
  ...
  public static void main(String[] args) {
	  HmoMemgetIxnV2 jtx = new HmoMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(10001023870l);
