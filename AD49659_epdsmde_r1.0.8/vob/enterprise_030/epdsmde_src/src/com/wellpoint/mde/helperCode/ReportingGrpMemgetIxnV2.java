...
public class ReportingGrpMemgetIxnV2 {
	...
	ProcessReportingGrpMemget objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessReportingGrpMemget();
  ...
  public static void main(String[] args) {
	  ReportingGrpMemgetIxnV2 jtx = new ReportingGrpMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(57448294);
