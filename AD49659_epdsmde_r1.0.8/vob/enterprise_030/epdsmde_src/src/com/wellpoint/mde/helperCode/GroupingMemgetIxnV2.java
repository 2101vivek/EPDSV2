...
public class GroupingMemgetIxnV2 {
	...
	ProcessGroupingMemget objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessGroupingMemget();
  ...
  public static void main(String[] args) {
	  GroupingMemgetIxnV2 jtx = new GroupingMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(10000054259l);
