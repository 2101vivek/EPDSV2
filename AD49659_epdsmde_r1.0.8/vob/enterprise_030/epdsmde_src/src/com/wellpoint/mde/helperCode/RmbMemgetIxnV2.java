...
public class RmbMemgetIxnV2{
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessRmbMemget();
  ...
  public static void main(String[] args) {
	  RmbMemgetIxnV2 jtx = new RmbMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(57074104);
