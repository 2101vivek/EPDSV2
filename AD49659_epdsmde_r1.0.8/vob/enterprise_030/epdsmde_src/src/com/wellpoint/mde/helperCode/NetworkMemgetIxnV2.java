...
public class NetworkMemgetIxnV2 {
	...
	ProcessNetworkMemget objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessNetworkMemget();
  ...
  public static void main(String[] args) {
	  NetworkMemgetIxnV2 jtx = new NetworkMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(57074114);
