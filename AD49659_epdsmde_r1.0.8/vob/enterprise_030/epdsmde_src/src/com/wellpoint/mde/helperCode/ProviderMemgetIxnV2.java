...
public class ProviderMemgetIxnV2
{
	...
	ProcessProviderMemget objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessProviderMemget();
  ...
  public static void main(String[] args) {
    	ProviderMemgetIxnV2 jtx = new ProviderMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(52376127);
		}
		catch (Exception ex)	{
			ex.printStackTrace();
		}
