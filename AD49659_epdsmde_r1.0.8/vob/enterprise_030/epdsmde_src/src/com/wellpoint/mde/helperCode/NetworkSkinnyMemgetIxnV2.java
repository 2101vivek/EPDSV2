...
public class NetworkSkinnyMemgetIxnV2 {
	...
	ProcessNetworkSkinny objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessNetworkSkinny();
  ...
  public static void main(String[] args) {
	  NetworkSkinnyMemgetIxnV2 jtx = new NetworkSkinnyMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(50640023);
