...
public class BusinessEntityMemgetIxnV2 {
	...
	ProcessBusEntityMemget objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessBusEntityMemget();
  ...
  public static void main(String[] args) {
	  BusinessEntityMemgetIxnV2 jtx = new BusinessEntityMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(51490473);
