...
public class OrgSkinnyMemgetIxnV2 {
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessOrgSkinny();
  ...
  public static void main(String[] args) {
	  OrgSkinnyMemgetIxnV2 jtx = new OrgSkinnyMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(10000052247l);
