...
import com.wellpoint.mde.Skinny.ProcessOrgCleanupSkinny;
import com.wellpoint.mde.generateRow.outData;
import com.wellpoint.mde.utils.ExtMemgetIxnUtils;

public class OrgCleanupSkinnyMemgetIxnV2
{
	...
	ProcessOrgCleanupSkinny objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessOrgCleanupSkinny();
  ...
  public static void main(String[] args) {
	  OrgCleanupSkinnyMemgetIxnV2 jtx = new OrgCleanupSkinnyMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(51364559 );
