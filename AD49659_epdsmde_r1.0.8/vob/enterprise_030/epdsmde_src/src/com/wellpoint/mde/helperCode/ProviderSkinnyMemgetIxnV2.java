...
public class ProviderSkinnyMemgetIxnV2
{
	...
	ProcessProviderSkinny objInstance;
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessProviderSkinny();
  ...
  public static void main(String[] args) {
    	ProviderSkinnyMemgetIxnV2 jtx = new ProviderSkinnyMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(51493018);
			//58922567
			//50097107

			//50096941
			/*10000062650L*//*51344408*/
