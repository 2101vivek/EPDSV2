...
import com.wellpoint.mde.CR209.ProcessOrgMemget;
...
public class ExecuteOrg {
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessOrgMemget();
  ...
  public static void main(String[] args) {
    	ExecuteOrg jtx = new ExecuteOrg();
		try	{
			
			jtx.execute_memGet(50368485);
