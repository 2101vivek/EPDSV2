...
public class HmoSkinnyMemgetIxnV2 {
	...
	public void execute_memGet(long entRecNum) throws Exception
	{
		...
		objInstance = new ProcessHmoSkinny();
  ...
  public static void main(String[] args) {
	  HmoSkinnyMemgetIxnV2 jtx = new HmoSkinnyMemgetIxnV2();
		try	{
			
			jtx.execute_memGet(55843585);
